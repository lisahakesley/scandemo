  ...
  <xsl:template match="labels">
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
      <fo:layout-master-set>
        <fo:simple-page-master master-name="PrepRecipeLabel" margin=".25in" page-width="2.4in" page-height="3.9in">
          <fo:region-body/>
        </fo:simple-page-master>
      </fo:layout-master-set>
      <fo:page-sequence master-reference="PrepRecipeLabel">
                      ...
                      <svg:svg width="2.4in" height="3.9in" xmlns:svg="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                          <svg:g transform="translate(154,5)">
                            <svg:g transform="rotate(90)" font-family="Verdana" font-size="12" >
                              ...
                              <svg:text x="0" y="60">Exp: <xsl:value-of select="expirationDate" /></svg:text>
                            </svg:g>
                          </svg:g>
                      </svg:svg>
                    </fo:instream-foreign-object>
